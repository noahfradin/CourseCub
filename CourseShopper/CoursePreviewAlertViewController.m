//
//  CoursePreviewAlertViewController.m
//  CourseShopper
//
...
@interface CoursePreviewAlertViewController ()

@end

@implementation CoursePreviewAlertViewController
...
- (void)viewDidLoad
{
  ...
  UIColor *timeLabelFontColor = [UIColor whiteColor];
    ...
    bookListLabel.text = @"Are you okay with navigating to\n Course Preview?";
