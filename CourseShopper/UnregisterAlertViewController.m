//
//  UnregisterAlertViewController.m
//  CourseShopper
//
...
@interface UnregisterAlertViewController ()

@end

@implementation UnregisterAlertViewController
...
- (void)viewDidLoad
{
    ...
    bookListLabel.text = @"Are you okay with unregistering\nfor this course?";
